...
- **🧑‍💻Thyroid Disease Data Analysis**
  ...
  - **Outcome**: Preprocessed data (elimination, imputation, one-hot encoding), visualized data, trained and compared logistic regression, SVM, decision tree, and random forest classifiers achieving **96%** highest accuracy.
  - [GitHub Repository](https://github.com/sumodha/thyroidDiseaseAnalysis)
